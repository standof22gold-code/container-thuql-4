...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-thuql-4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-thuql-4.containers.anotherwebservice.com/
...
```
git clone git@github.com:standof22gold-code/container-thuql-4.git
cd container-thuql-4
```
...
```
docker attach container-thuql-4
```
